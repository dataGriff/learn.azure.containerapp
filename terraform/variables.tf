...
locals {
  ...
  la_name               = "${local.environment_shortcode}${var.organisation}la${local.region_shortcode}${var.unique_namespace}"
  ace_name              = "${local.environment_shortcode}${var.organisation}ace${local.region_shortcode}${var.unique_namespace}"
  container_app_name    = "${local.environment_shortcode}${var.domain}aca${local.region_shortcode}${var.unique_namespace}"
